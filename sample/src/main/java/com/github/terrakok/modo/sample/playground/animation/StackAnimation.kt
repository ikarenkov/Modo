 ...
 */
@Composable
internal fun autoLaunchScreensAnimation(
...
@Composable
internal fun RenderAnimationItems(
    modifier: Modifier,
...
): MutableState<List<AnimationItem>> = rememberAnimationItemsSimple(
    state = state,
...
@OptIn(ExperimentalModoApi::class)
internal fun calculateStackAnimationItems(
...
internal fun calculateStackAnimationItems(
    ...
    val oldDesiredScreens = getStackScreensToRender(oldStack)
    val newDesiredScreens = getStackScreensToRender(stack)
    return calculateStackAnimationItems(oldDesiredScreens, newDesiredScreens, oldStack, stack)
}
...
private fun rememberStackAnimationItemsQueued(
    state: State<StackState>,
): MutableState<List<AnimationItem>> = rememberAnimationItemsQueued(
    state = state,
    getScreensToRender = { stackState: StackState -> getStackScreensToRender(stackState.stack) },
