...
import com.github.terrakok.androidcomposeapp.screens.containers.LazyColumnScreenContainer
...
private fun rememberButtons(
    ...
    listOf<Pair<String, () -> Unit>>(
        ...
        "Screens in LazyColumn" to { navigator.forward(RemovableItemContainerScreen()) },
        "Horizontal Pager" to { navigator.forward(HorizontalPagerScreen()) },
        "LazyColumn" to { navigator.forward(LazyColumnScreenContainer()) },
